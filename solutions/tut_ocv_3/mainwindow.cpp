...
//cv::Ptr< cv::ml::DTrees>
cv::Ptr< cv::ml::RTrees > predictor = cv::ml::RTrees::create();
...
//    predictor->setRegressionAccuracy(0);
//    predictor->setUseSurrogates(false);
//    predictor->setMaxCategories(15);
//    predictor->setPriors(Mat());
//    predictor->setCalculateVarImportance(true);
//    predictor->setActiveVarCount(4);
    predictor->setTermCriteria(cv::TermCriteria(cv::TermCriteria::MAX_ITER, 100,0.01f));
