...
{
    cv::VideoCapture cam("../data/movie.mov");
...
//    cv::bilateralFilter(frameIn, frame, 15, 255, 10);
     ...
     * - сделать для нескольких фильтров ползунки (скролбары) настройки 
     * параметров, экспериментирвоать
     * - поробовать линейные фильтры https://docs.opencv.org/2.4/doc/tutorials/imgproc/imgtrans/filter_2d/filter_2d.html
...
void MainWindow::on_pushButton_readImtoFilter_clicked()
{
     ...
     * - сравнить с чистым изображением без шумов (clear)
    */
